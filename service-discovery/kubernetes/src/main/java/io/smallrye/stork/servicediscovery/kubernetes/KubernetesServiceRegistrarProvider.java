...
@ServiceRegistrarType(value = "kubernetes")
public class KubernetesServiceRegistrarProvider
        implements ServiceRegistrarProvider<KubernetesRegistrarConfiguration> {

    private static final Logger log = LoggerFactory.getLogger(KubernetesServiceRegistrarProvider.class);

    @Override
    public ServiceRegistrar createServiceRegistrar(KubernetesRegistrarConfiguration config,
