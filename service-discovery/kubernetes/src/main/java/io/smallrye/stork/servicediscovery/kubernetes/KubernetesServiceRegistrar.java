...
public class KubernetesServiceRegistrar implements ServiceRegistrar {
    ...
    @Override
    public Uni<Void> registerServiceInstance(String serviceName, Metadata<? extends MetadataKey> metadata, String ipAddress,
            int port) {
    ...
    private void registerKubernetesService(String application, Metadata<? extends MetadataKey> metadata, String ipAddress,
            int port) {
