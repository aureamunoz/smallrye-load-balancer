...
public class ConfigClassWriter {
    ...
    public String createConfig(Element element, String type, LoadBalancerAttribute[] attributes) throws IOException {
        return createConfig(element, type, "", LoadBalancerConfig.class,
    ...
    public String createConfig(Element element, String type, ServiceDiscoveryAttribute[] attributes) throws IOException {
        return createConfig(element, type, "", ServiceDiscoveryConfig.class,
    ...
    public String createConfig(Element element, String type, ServiceRegistrarAttribute[] attributes) throws IOException {
        return createConfig(element, type, "Registrar", ServiceRegistrarConfig.class,
    ...
    public String createServiceRegistrarLoader(Element element,
        ...
        try (PrintWriter out = new PrintWriter(javaFile.openWriter())) {
            ...
            writeClassDeclaration(
                    format("%s implements %s", simpleClassName, ServiceRegistrarLoader.class.getName()),
            ...
            out.println("   @Override");
            out.println(format(
                    "   public ServiceRegistrar createServiceRegistrar(ServiceRegistrarConfig config, "));
    ...
    public String createConfig(Element element, String type, String suffix, Class configClazz, String comment,
        ...
        try (PrintWriter out = new PrintWriter(file.openWriter())) {
            ...
            writeImportStatement(configClazz, out);
            writeClassDeclaration(simpleClassName, configClazz, comment, out);
    ...
    private void writeClassDeclaration(String simpleName, Class configClazz, String comment, PrintWriter out) {
        out.println();
        out.println("/**");
        out.println(" * " + comment);
        out.println(" */");
        out.println(format(" public class %s implements %s{", simpleName, configClazz.getName()));
    }
